declare module "arrays" {
    ...
    */
    function flatMap<T, R>(items: T[], fn: (item: T, index: number, array: T[]) => R[], thisArg?: any): R[];
    /**
    ...
    */
    function quantile(xs: number[], q: number, sort?: boolean): number[];
    /**
